...
首位は `pressure_white_baseline`（score 55.5 / overall 59.4% / vs Black 43.8%）。 現行 `pressure_white_baseline` 比の vs Black 差分は +0%。 安定候補（vs Black 45%以上、0F/1W以下）は 0 件。 上位候補: pressure_white_baseline 43.8% / pressure_white_low_stone_focus_missed_attack_light_v1 37.5%。
...
| ---: | --- | --- | --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- | --- | --- |
| 1 | pressure_white_baseline<br>基準: pressure-normal / white | baseline | pressure-normal<br>通常プレッシャー | 55.5 | 19-13-0 | 59.4% | 43.8% (7-9-0) | 75% (6-2-0) | 75% (6-2-0) | 12.3 | 3.9 | shield:128, wake_up:90, master_attack:62 | Ex 23.3%<br>Setup 52.1%<br>LowS 53.3%<br>ShieldConv 35.9%<br>Pygmy 38/162<br>Poly 66.7% | 0F/0W | 盾の成果化不足<br>布石後の石枯渇 |
| 2 | pressure_white_low_stone_focus_missed_attack_light_v1<br>本実装候補: 白低石focus攻撃見送り抑制軽量 | hybrid | pressure-normal<br>通常プレッシャー | 43.4 | 13-19-0 | 40.6% | 37.5% (6-10-0) | 50% (4-4-0) | 37.5% (3-5-0) | 13.2 | 3.3 | shield:115, wake_up:100, master_attack:78 | Ex 22.8%<br>Setup 52.2%<br>LowS 54.4%<br>ShieldConv 47%<br>Pygmy 57/251<br>Poly 75% | 0F/0W | 黒に弱い<br>盾の成果化不足<br>布石後の石枯渇 |

## Loop Results

| Rank | Variant | Hypothesis | Tuning | Score | Overall | vs Black | vs Decoy | vs White | Usage | Intent | Notes |
| ---: | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | --- | --- |
| 1 | pressure_white_baseline<br>基準: pressure-normal / white | 現行白専用AIの基準。黒速攻へどこまで耐えるかを見る。 | - | 55.5 | 59.4% | 43.8% (7-9-0) | 75% (6-2-0) | 75% (6-2-0) | shield:128, wake_up:90, master_attack:62 | Ex 23.3%<br>Setup 52.1%<br>LowS 53.3%<br>ShieldConv 35.9%<br>Pygmy 38/162<br>Poly 66.7% | 盾の成果化不足<br>布石後の石枯渇 |
| 2 | pressure_white_low_stone_focus_missed_attack_light_v1<br>本実装候補: 白低石focus攻撃見送り抑制軽量 | 白マスター限定で、攻撃という同ターンの仕事が残っている低石focusだけを軽く抑える。 | situational whiteLowStoneFocusMissedAttackPenalty:4 | 43.4 | 40.6% | 37.5% (6-10-0) | 50% (4-4-0) | 37.5% (3-5-0) | shield:115, wake_up:100, master_attack:78 | Ex 22.8%<br>Setup 52.2%<br>LowS 54.4%<br>ShieldConv 47%<br>Pygmy 57/251<br>Poly 75% | 黒に弱い<br>盾の成果化不足<br>布石後の石枯渇 |
...
| pressure_white_low_stone_focus_missed_attack_light_v1_vs_black_pressure_strong_player | player | black_pressure_strong | P 3 / C 1 / D 0 | 0F/0W |
...
| pressure_white_low_stone_focus_missed_attack_light_v1_vs_black_pressure_pressure_player | player | black_pressure_pressure | P 1 / C 3 / D 0 | 0F/0W |
...
| pressure_white_low_stone_focus_missed_attack_light_v1_vs_white_pressure_strong_cpu | cpu | white_pressure_strong | P 2 / C 2 / D 0 | 0F/0W |
