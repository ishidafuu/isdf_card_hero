...
- target acted on response: 15
- harmful response: 5
- board harmful response: 2
- master-only response: 3
- damaged master: 3
- damaged own monster: 0
- killed own monster: 2
- target leveled up on response: 1
- focus alternative available: 126
- immediate finish alternative available: 5
- avg target HP after chip: 2.53
- selected minus best focus avg: 308.6
- selected minus immediate finish avg: 221.7

## Buckets

- by HP after: HP2:59, HP4:32, HP1:31, HP3:31, HP5:7
- by decision: attack:114, master_attack:46
- by target: 真勇者ダイン Lv1:29, デスシープ Lv1:20, ヤミー Lv1:17, 鉄拳シグマ Lv1:12, ドノマンティス Lv1:11, ボムゾウ Lv1:11, 真勇者ダイン Lv2:9, モーガン Lv2:8, ポリスピナー Lv1:7, デスシープ Lv2:6, ドノマンティス Lv2:5, ヤミー Lv2:5, ヤンバル Lv2:5, モーガン Lv1:4, 真勇者ダイン Lv3:4, ヤンバル Lv1:3, ポリスピナー Lv2:2, ピグミィ Lv2:1, ボムゾウ Lv2:1

## Conclusion

- 非リーサル前衛削りは 160件。返しで対象が行動したのは 15件、従来の被害判定は 5件、同ターン中に処理へ変換できたのは 141件。
- 盤面被害は 2件、マスターのみ被弾は 3件。白ミラーでは盤面被害を主指標にし、マスターのみ被弾は詰めろ圏かどうかを別途見る。
- 盤面被害の内訳は、残HP1が 0件、残HP2以上が 2件。
- 盤面被害イベントのうち、ためる代替が候補にあったものは 2件。即撃破代替が候補にあった削りは全体で 5件。
...
### harmful_response / seed 76105 / A-as-player / turn 10

- selected: ピグミィ スパイクボール -> ヤミー@cpu_front_left / score 194.1
- target: ヤミー Lv2 5->4 at cpu_front_left
- attacker: ピグミィ
- stones: acting 5->5, response 0->0
- alternatives: focus -, finish -, end end turn (-495.8)
- response action: ヤミー attack -> player master
- flags: acted=true, masterDamage=1, monsterDamage=false, monsterKill=false, levelUp=false, converted=false
- state: HP P/C 9/8 / stones P/C 5/0 / hand P/C 6/3
- before: cpu_front_left:CF:ヤミー Lv2 HP5 act1/1 | cpu_front_right:CF:デスシープ Lv1 HP5 act1/1 | player_front_right:PF:ドノマンティス Lv2 HP5 act1/1 focus | player_back_left:PB:ヤンバル Lv1 HP3 act1/1 | player_back_right:PB:ピグミィ Lv2 HP3 act0/2 focus
- after chip: cpu_front_left:CF:ヤミー Lv2 HP4 act1/1 | cpu_front_right:CF:デスシープ Lv1 HP5 act1/1 | player_front_right:PF:ドノマンティス Lv2 HP5 act1/1 focus | player_back_left:PB:ヤンバル Lv1 HP3 act1/1 | player_back_right:PB:ピグミィ Lv2 HP3 act1/2
- final: cpu_back_left:CB:ヤンバル Lv1 HP3 prep | cpu_front_left:CF:ヤミー Lv2 HP4 act1/1 shield | cpu_front_right:CF:デスシープ Lv1 HP5 act1/1 | player_front_left:PF:ボムゾウ Lv1 HP6 act0/1 | player_front_right:PF:ドノマンティス Lv2 HP5 act0/1 | player_back_left:PB:ヤンバル Lv1 HP3 act0/1 | player_back_right:PB:ピグミィ Lv2 HP3 act0/2 focus

### harmful_response / seed 76106 / A-as-player / turn 10

- selected: ヤンバル wild_claw -> 真勇者ダイン@player_front_right / score 21.5
- target: 真勇者ダイン Lv1 6->5 at player_front_right
- attacker: ヤンバル
- stones: acting 4->4, response 5->5
- alternatives: focus focus ヤンバル (-18.8), finish -, end end turn (-122)
- response action: 真勇者ダイン ダイン斬り -> ヤミー@cpu_front_right
- flags: acted=true, masterDamage=0, monsterDamage=false, monsterKill=true, levelUp=true, converted=false
- state: HP P/C 7/9 / stones P/C 5/4 / hand P/C 4/4
- before: cpu_back_left:CB:ピグミィ Lv1 HP3 act2/2 | cpu_back_right:CB:ヤンバル Lv1 HP3 act0/1 | cpu_front_left:CF:ポリスピナー Lv2 HP3 act2/2 | cpu_front_right:CF:ヤミー Lv1 HP5 act1/1 focus | player_front_right:PF:真勇者ダイン Lv1 HP6 act1/1 focus | player_back_right:PB:ピグミィ Lv2 HP3 act2/2 focus
- after chip: cpu_back_left:CB:ピグミィ Lv1 HP3 act2/2 | cpu_back_right:CB:ヤンバル Lv1 HP3 act1/1 | cpu_front_left:CF:ポリスピナー Lv2 HP3 act2/2 | cpu_front_right:CF:ヤミー Lv1 HP5 act1/1 focus | player_front_right:PF:真勇者ダイン Lv1 HP5 act1/1 | player_back_right:PB:ピグミィ Lv2 HP3 act2/2 focus
- final: cpu_back_left:CB:ピグミィ Lv1 HP3 act0/2 | cpu_front_left:CF:ポリスピナー Lv2 HP3 act0/2 | cpu_front_right:CF:ヤンバル Lv1 HP3 act0/1 | player_front_right:PF:真勇者ダイン Lv2 HP6 act1/1 | player_back_right:PB:ピグミィ Lv2 HP3 act2/2
