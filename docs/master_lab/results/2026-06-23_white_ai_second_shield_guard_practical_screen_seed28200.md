...
首位は `pressure_white_baseline`（score 53.5 / overall 55.6% / vs Black 58.3%）。 現行 `pressure_white_baseline` 比の vs Black 差分は +0%。 安定候補（vs Black 45%以上、0F/1W以下）は 1 件。 上位候補: pressure_white_baseline 58.3%。
...
| ---: | --- | --- | --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- | --- | --- |
| 1 | pressure_white_baseline<br>基準: pressure-normal / white | baseline | pressure-normal<br>通常プレッシャー | 53.5 | 10-8-0 | 55.6% | 58.3% (7-5-0) | 50% (3-3-0) | - | 14 | - | shield:95, wake_up:64, master_attack:37 | - | 0F/0W | 黒耐性あり |

## Loop Results

| Rank | Variant | Hypothesis | Tuning | Score | Overall | vs Black | vs Decoy | vs White | Usage | Intent | Notes |
| ---: | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | --- | --- |
| 1 | pressure_white_baseline<br>基準: pressure-normal / white | 現行白専用AIの基準。黒速攻へどこまで耐えるかを見る。 | - | 53.5 | 55.6% | 58.3% (7-5-0) | 50% (3-3-0) | - | shield:95, wake_up:64, master_attack:37 | - | 黒耐性あり |
...
| pressure_white_baseline_vs_decoy_back_stable_cpu | cpu | decoy_back_stable | P 1 / C 2 / D 0 | 0F/0W |
