...
生成: 2026-06-20T01:20:51.236Z
参照候補: `pressure_white_low_stone_focus_missed_attack_light_v1`
比較候補: `pressure_white_baseline`
相手: black_pressure_strong, black_pressure_pressure
seed: 39600-39615 / 各seat
確認範囲: turn 6 まで

## Conclusion

- pressure_white_low_stone_focus_missed_attack_light_v1 vs pressure_white_baseline: 参照だけが勝ったseedは 0/64、比較だけが勝ったseedは 2/64。
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| pressure_white_baseline | 64 | 0 | 2 | 24 | 38 | 0 | - |
