...
- selected top1: 0/6
- selected average rank: 13.33
- average gap to best: 46.5
- max gap to best: 118
- selected response top1: 0/6
- selected average response rank: 5.67
- average response gap to best: 57.9
...
- 平均ギャップは 46.5 点。80点以上のズレは 2/6。
- 相手応答後1位だった局面は 0/6。応答後平均ギャップは 57.9 点。80点以上のズレは 2/6。
- 現行選択はシールド 1/6、フォーカス 2/6 を含む。終端1位はシールド 0/6、フォーカス 0/6。応答後1位はシールド 2/6、フォーカス 1/6。
...
3. terminal -156.2 (+192.8) / response -301.4 (-145.2) / guide 661.3
   ...
   - opponent response: terminal -301.4 (-145.2)
     - actions: ピグミィ スパイクボール -> モーガン [449.8] -> ピグミィ スパイクボール -> モーガン [673.4] -> ボムゾウ self_bomb -> モーガン [1031.5] -> summon ヤンバル -> cpu_back_right [173.5] -> focus ピグミィ [-23.5] -> focus ピグミィ [-23.1] -> master shield -> ピグミィ@cpu_front_right [-66] -> end turn [-198.5]
...
- selectedResponseRank: 8
- terminalGapToBest: 118
- responseGapToBest: 62.2
...
1. terminal -3 (-120.4) / response -63 (-60) / guide -876
   - actions: focus デスシープ [44] -> move モーガン player_front_left->player_back_right [-66.4] -> 鉄拳シグマ attack -> ドノマンティス [-203.3] -> master master_attack -> ドノマンティス@cpu_front_right [-241.1] -> end turn [-409.2]
   - final: turn 5 / current cpu / HP player/cpu 10/10 / stones player/cpu 2/3 / hand player/cpu 3/4
   - metrics: HP 10/10, stones 2/3, boardValue 460/390, ready 0/3, shield 0/0, Lv2+ 0/0
   - board: cpu_back_right:CB:ピグミィ Lv1 HP3 act0/2 | cpu_front_left:CF:ヤミー Lv1 HP5 act0/1 | cpu_front_right:CF:ドノマンティス Lv1 HP1 act0/1 | player_front_right:PF:鉄拳シグマ Lv1 HP6 act1/1 | player_back_left:PB:デスシープ Lv1 HP6 act1/1 focus | player_back_right:PB:モーガン Lv1 HP4 act1/1
   - opponent response: terminal -63 (-60)
     - actions: ドノマンティス attack -> 鉄拳シグマ [291.8] -> ピグミィ スパイクボール -> 鉄拳シグマ [288.1] -> ピグミィ スパイクボール -> 鉄拳シグマ [373.8] -> master master_attack -> 鉄拳シグマ@player_front_right [375.3] -> focus ヤミー [-54.4] -> end turn [-239.8]
     - final: turn 6 / current player / HP player/cpu 10/10 / stones player/cpu 6/0 / hand player/cpu 4/4
     - metrics: HP 10/10, stones 6/0, boardValue 300/390, ready 2/0, shield 0/0, Lv2+ 0/0
     - board: cpu_back_right:CB:ピグミィ Lv1 HP3 act2/2 | cpu_front_left:CF:ヤミー Lv1 HP5 act1/1 focus | cpu_front_right:CF:ドノマンティス Lv1 HP1 act1/1 | player_front_left:PF:デスシープ Lv1 HP6 act0/1 focus | player_front_right:PF:モーガン Lv1 HP4 act0/1

#### Top terminal plans

1. terminal 115 (-2.4) / response -92 (-207) / guide 986.5
   - actions: master master_attack -> ドノマンティス@cpu_front_right [-1] -> 鉄拳シグマ attack -> ドノマンティス [414.7] -> move デスシープ player_back_left->player_back_right [441.6] -> モーガン arc_drive -> ドノマンティス [480.3] -> end turn [-349.1]
   - final: turn 5 / current cpu / HP player/cpu 10/10 / stones player/cpu 1/4 / hand player/cpu 3/4
   - metrics: HP 10/10, stones 1/4, boardValue 560/280, ready 0/2, shield 0/0, Lv2+ 1/0
   - board: cpu_front_left:CF:ヤミー Lv1 HP5 act0/1 | cpu_front_right:CF:ピグミィ Lv1 HP3 act0/2 | player_front_left:PF:モーガン Lv2 HP4 act1/1 | player_front_right:PF:鉄拳シグマ Lv1 HP6 act1/1 | player_back_right:PB:デスシープ Lv1 HP6 act1/1
   - opponent response: terminal -92 (-207)
     - actions: ヤミー attack -> モーガン [449.3] -> ピグミィ スパイクボール -> モーガン [481.7] -> ピグミィ スパイクボール -> モーガン [741.9] -> summon 真勇者ダイン -> cpu_back_left [142.8] -> summon ヤミー -> cpu_back_right [82.2] -> end turn [-57.5]
     - final: turn 6 / current player / HP player/cpu 10/10 / stones player/cpu 6/1 / hand player/cpu 4/2
     - metrics: HP 10/10, stones 6/1, boardValue 320/690, ready 2/0, shield 0/0, Lv2+ 0/1
     - board: cpu_back_left:CB:真勇者ダイン Lv1 HP6 prep | cpu_back_right:CB:ヤミー Lv1 HP5 prep | cpu_front_left:CF:ヤミー Lv1 HP5 act1/1 | cpu_front_right:CF:ピグミィ Lv2 HP3 act2/2 | player_front_right:PF:鉄拳シグマ Lv1 HP6 act0/1 | player_back_right:PB:デスシープ Lv1 HP6 act0/1
2. terminal 22 (-95.4) / response -30 (-52) / guide -290.5
...
3. terminal 19 (-98.4) / response -33 (-52) / guide -423.1
   - actions: master master_attack -> ドノマンティス@cpu_front_right [-1] -> end turn [-422.1]
   - final: turn 5 / current cpu / HP player/cpu 10/10 / stones player/cpu 2/3 / hand player/cpu 3/4
   - metrics: HP 10/10, stones 2/3, boardValue 460/410, ready 3/3, shield 0/0, Lv2+ 0/0
   - board: cpu_back_right:CB:ピグミィ Lv1 HP3 act0/2 | cpu_front_left:CF:ヤミー Lv1 HP5 act0/1 | cpu_front_right:CF:ドノマンティス Lv1 HP3 act0/1 | player_front_left:PF:モーガン Lv1 HP4 act0/1 focus | player_front_right:PF:鉄拳シグマ Lv1 HP6 act0/1 focus | player_back_left:PB:デスシープ Lv1 HP6 act0/1 focus
   - opponent response: terminal -33 (-52)
     - actions: ピグミィ スパイクボール -> モーガン [318.4] -> ヤミー attack -> モーガン [318.2] -> ドノマンティス attack -> 鉄拳シグマ [283.7] -> ピグミィ スパイクボール -> 鉄拳シグマ [258.2] -> master master_attack -> モーガン@player_front_left [175.2] -> end turn [-194]
     - final: turn 6 / current player / HP player/cpu 10/10 / stones player/cpu 6/0 / hand player/cpu 4/4
     - metrics: HP 10/10, stones 6/0, boardValue 300/410, ready 2/0, shield 0/0, Lv2+ 0/0
     - board: cpu_back_right:CB:ピグミィ Lv1 HP3 act2/2 | cpu_front_left:CF:ヤミー Lv1 HP5 act1/1 | cpu_front_right:CF:ドノマンティス Lv1 HP3 act1/1 | player_front_left:PF:デスシープ Lv1 HP6 act0/1 focus | player_front_right:PF:鉄拳シグマ Lv1 HP4 act0/1

#### Top response-adjusted plans

1. terminal 18 (-99.4) / response -0.8 (-18.8) / guide -444.7
   - actions: focus デスシープ [44] -> move モーガン player_front_left->player_back_right [-66.4] -> end turn [-422.2]
   - final: turn 5 / current cpu / HP player/cpu 10/10 / stones player/cpu 5/3 / hand player/cpu 3/4
...
2. terminal 15 (-102.4) / response -3.8 (-18.8) / guide -705.5
   - actions: focus デスシープ [44] -> move モーガン player_front_left->player_back_right [-66.4] -> master master_attack -> ドノマンティス@cpu_front_right [-254.7] -> end turn [-428.4]
   - final: turn 5 / current cpu / HP player/cpu 10/10 / stones player/cpu 2/3 / hand player/cpu 3/4
...
3. terminal 15 (-102.4) / response -3.8 (-18.8) / guide -443.6
   - actions: master master_attack -> ドノマンティス@cpu_front_right [-1] -> focus デスシープ [44] -> move モーガン player_front_left->player_back_right [-58.2] -> end turn [-428.4]
   - final: turn 5 / current cpu / HP player/cpu 10/10 / stones player/cpu 2/3 / hand player/cpu 3/4
   - metrics: HP 10/10, stones 2/3, boardValue 460/410, ready 1/3, shield 0/0, Lv2+ 0/0
   - board: cpu_back_right:CB:ピグミィ Lv1 HP3 act0/2 | cpu_front_left:CF:ヤミー Lv1 HP5 act0/1 | cpu_front_right:CF:ドノマンティス Lv1 HP3 act0/1 | player_front_right:PF:鉄拳シグマ Lv1 HP6 act0/1 focus | player_back_left:PB:デスシープ Lv1 HP6 act1/1 focus | player_back_right:PB:モーガン Lv1 HP4 act1/1
   - opponent response: terminal -3.8 (-18.8)
