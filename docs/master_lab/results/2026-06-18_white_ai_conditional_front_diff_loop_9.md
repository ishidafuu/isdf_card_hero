...
生成: 2026-06-18T14:34:47.797Z
参照候補: `pressure_attack_monster_plus4`
比較候補: `pressure_white_baseline`, `pressure_white_enemy_front_attack_v1`
相手: black_pressure_strong, black_pressure_pressure
seed: 24200-24205 / 各seat
確認範囲: turn 8 まで

## Conclusion

- pressure_attack_monster_plus4 vs pressure_white_baseline: 参照だけが勝ったseedは 0/24、比較だけが勝ったseedは 2/24。
- pressure_attack_monster_plus4 vs pressure_white_enemy_front_attack_v1: 参照だけが勝ったseedは 0/24、比較だけが勝ったseedは 1/24。
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| pressure_white_baseline | 24 | 0 | 2 | 4 | 18 | 0 | - |
| pressure_white_enemy_front_attack_v1 | 24 | 0 | 1 | 4 | 19 | 0 | - |
...
### pressure_white_enemy_front_attack_v1
