...
首位は `pressure_white_baseline`（score 46.4 / overall 48.4% / vs Black 37.5%）。 現行 `pressure_white_baseline` 比の vs Black 差分は +0%。 安定候補（vs Black 45%以上、0F/1W以下）は 0 件。 上位候補: pressure_white_baseline 37.5%。
...
| ---: | --- | --- | --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- | --- | --- |
| 1 | pressure_white_baseline<br>基準: pressure-normal / white | baseline | pressure-normal<br>通常プレッシャー | 46.4 | 31-33-0 | 48.4% | 37.5% (12-20-0) | 56.3% (9-7-0) | 62.5% (10-6-0) | 12.6 | 3.2 | shield:278, wake_up:223, master_attack:124 | Ex 23%<br>Setup 52.6%<br>LowS 53.9%<br>ShieldConv 39.6%<br>Pygmy 78/415<br>Poly 57.9% | 0F/0W | 黒に弱い<br>盾の成果化不足<br>布石後の石枯渇 |

## Loop Results

| Rank | Variant | Hypothesis | Tuning | Score | Overall | vs Black | vs Decoy | vs White | Usage | Intent | Notes |
| ---: | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | --- | --- |
| 1 | pressure_white_baseline<br>基準: pressure-normal / white | 現行白専用AIの基準。黒速攻へどこまで耐えるかを見る。 | - | 46.4 | 48.4% | 37.5% (12-20-0) | 56.3% (9-7-0) | 62.5% (10-6-0) | shield:278, wake_up:223, master_attack:124 | Ex 23%<br>Setup 52.6%<br>LowS 53.9%<br>ShieldConv 39.6%<br>Pygmy 78/415<br>Poly 57.9% | 黒に弱い<br>盾の成果化不足<br>布石後の石枯渇 |
...
| pressure_white_baseline_vs_decoy_back_stable_player | player | decoy_back_stable | P 3 / C 5 / D 0 | 0F/0W |
| pressure_white_baseline_vs_decoy_back_stable_cpu | cpu | decoy_back_stable | P 2 / C 6 / D 0 | 0F/0W |
| pressure_white_baseline_vs_white_pressure_strong_player | player | white_pressure_strong | P 4 / C 4 / D 0 | 0F/0W |
| pressure_white_baseline_vs_white_pressure_strong_cpu | cpu | white_pressure_strong | P 2 / C 6 / D 0 | 0F/0W |
