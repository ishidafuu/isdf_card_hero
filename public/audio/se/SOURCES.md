...
| App file | Temporary source file | Source page | Initial use |
| --- | --- | --- | --- |
| `select.mp3` | `sound/game01/select01.mp3` | https://taira-komori.net/game01.html | Selection |
| `confirm.mp3` | `sound/game01/button01a.mp3` | https://taira-komori.net/game01.html | Pending action confirmation |
| `summon.mp3` | `sound/magic01/encounter.mp3` | https://taira-komori.net/magic01.html | Summon |
| `attack.mp3` | `sound/attack01/swing1.mp3` | https://taira-komori.net/attack01.html | Attack |
| `damage.mp3` | `sound/attack01/damaged1.mp3` | https://taira-komori.net/attack01.html | Damage |
